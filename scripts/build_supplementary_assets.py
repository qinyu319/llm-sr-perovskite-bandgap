...
# Figure S7: direct M4 repeated-run heatmap plus cross-provider summary.
direct = [
    json.loads(line)
...
fig.tight_layout()
save(fig, "figure_s7_llm_stochasticity.png")

# Figure S6: symbolic baseline performance/complexity.
...
save(fig, "figure_s6_symbolic_baselines.png")
...
shutil.copy2(
    ROOT / "external_validation" / "Fig_external_validation.png",
    FIG / "figure_s13_external_validation.png",
)
shutil.copy2(
    ROOT / "figures" / "main" / "figure6_design_map.png",
    FIG / "figure_s14_design_maps.png",
)
